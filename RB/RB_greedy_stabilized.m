function [ errlist, selected_mu, PP, Arb_decomp, Lrb_decomp, ...
           Rmat, f_parallel, f_perp] = RB_greedy_stabilized( tol, Nmax, Xi, BB, AA_decomp, LL_decomp ) 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% RB_offline :
...
while (N < Nmax)&&(maxres > tol)
    ...
    [ maxres, mu_star ] = RB_argmax_resnorm_stabilized(Xi, Arb_decomp, Lrb_decomp, Rmat, f_parallel, f_perp);
